...
N_FOLDS = 5
MAX_EVALS = 100
IN_FILE = '~/Merck/Data/ACT1_train_50_corr_red.csv'
OUT_FILE = '../Results/RandomSearch_Tuning_50_corr_red_RF_iter100_3scores.csv'
...
param_grid = {
              ...
              "n_estimators": list(np.linspace(50, 1000, dtype=int))
             }
...
# Write column names
headers = ['iteration', 'runtime', 'r2_score', 'mape_score', 'mae_score', 'max_depth', 'min_samples_split', 'min_samples_leaf', 'n_estimators', 'hyperparameters']
...
def objective(hyperparameters):
    ...
    writer = csv.writer(of_connection)
    writer.writerow([ITERATION, run_time, score_r2, score_mape, score_mae, hyperparameters["max_depth"], hyperparameters["min_samples_split"], hyperparameters["min_samples_leaf"], hyperparameters["n_estimators"], hyperparameters])
    of_connection.close()
